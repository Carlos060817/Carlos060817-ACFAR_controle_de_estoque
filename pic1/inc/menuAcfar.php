...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu tm" id="navDrop">
        ...
        <a href="<?php BASEURL; ?>../usuarios/usuarioacfar.php" class="dropdown-item">Cadastrar Usuários</a>
    </div>
</li>
...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu tm" id="navDrop">
        ...
        <a href="<?php BASEURL; ?>../usuarios/index.php" class="dropdown-item">Usuarios Cadastrados</a>
    </div>
</li>
